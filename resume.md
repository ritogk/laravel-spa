...
例として、建設会社向け基幹システムの新規開発案件では、サーバー構成、フロント、バックエンドは全て私の方で行っていました。  
また、常にシステムとして正しいかどうかの考慮や、後々の事を考慮して実装するようにしています。  
具体例としては、複雑なバッチ処理の結果の理由を後々突っ込まれる事を予想してログ機能を事前に作成や  
...
vueはdomの更新が頻繁に起きる画面や、セッション管理が面倒な画面に導入して  
